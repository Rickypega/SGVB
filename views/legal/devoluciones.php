        ...
        <div class="col-lg-10">
            <div class="glass-card p-4 p-md-5 animate-fade-in border-secondary shadow-lg">
                <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom border-secondary flex-wrap gap-2">
                    <div>
                        <h1 class="fw-extrabold text-gradient mb-0 display-6">Política de Devolución</h1>
                    </div>
                ...
                <div class="text-light" style="line-height: 1.8;">
                    ...
                    <h4 class="fw-bold mt-4 mb-3 text-gradient-accent"><i class="bi bi-check-circle-fill text-success me-2"></i> 1. Condición Fundamental para Reintegro </h4>
                    <p>
                        Para solicitar y obtener el reintegro inmediato del valor pagado por la renta de un libro, audiolibro o artículo digital, <strong>el lector no debe haber abierto ni iniciado la lectura en el Visor Digital.</strong>
                    </p>
                    <div class="alert bg-dark border border-success text-success p-3 rounded-4 mb-4">
                        <i class="bi bi-shield-check me-2"></i>
                        <strong>Garantía de Satisfacción:</strong> Si cometiste un error en tu selección o añadiste un libro equivocado y aún no has ingresado al botón de "Leer" o "Escuchar" en tu panel, podrás devolverlo instantáneamente y el 100% de los Créditos SGBV ⛃ pagados volverá en segundos a tu saldo disponible.
                    </div>

                    <h4 class="fw-bold mt-4 mb-3 text-gradient-accent"><i class="bi bi-exclamation-triangle-fill text-warning me-2"></i> 2. Pérdida del Derecho de Reintegro </h4>
                    <p>
                        Una vez que el usuario hace clic en el botón de lectura/escucha del recurso, a partir de ese preciso instante:
                    </p>
                    <ul>
                    ...
                    <h4 class="fw-bold mt-4 mb-3 text-gradient-accent"><i class="bi bi-arrow-repeat me-2"></i> 3. Devolución Automática al Cumplir 14 Días</h4>
                    <p>
